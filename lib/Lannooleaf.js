...
export class Lannooleaf {
    ...
    GetAdjList(graph) {
        return new Promise((resolve) => __awaiter(this, void 0, void 0, function* () {
            yield this.GetAdjListSize()
                .then((size) => __awaiter(this, void 0, void 0, function* () {
                yield this.GetData(lannooleafconst.GetAdjListMessage, size)
                    .then(dataBuffer => {
                    if (size == 1) {
                        ...
                        for (i; i < dataBuffer.length; i += 3) {
                            graph.AddEdge(dataBuffer[i], dataBuffer[i + 1], dataBuffer[i + 3]);
                        }
                        ;
                    }
                    resolve();
    ...
    GetData(message, numberOfBytes) {
        return new Promise((reslove) => __awaiter(this, void 0, void 0, function* () {
            yield this.spi_controller.transfer(message, (error, message) => __awaiter(this, void 0, void 0, function* () {
                if (error)
                    throw error;
    ...
    GetAdjListSize() {
        return new Promise((reslove) => __awaiter(this, void 0, void 0, function* () {
            yield this.GetData(lannooleafconst.GetAdjListSizeMessage, 2)
                .then(data => {
